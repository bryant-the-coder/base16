...
local function apply_base16_theme(theme)
    ...
    highlight("TSKeyword", theme.base0B, nil, "none", nil)
    highlight("TSKeywordFunction", theme.base0B, nil, "none", nil)
    ...
    highlight("TSKeywordOperator", theme.base0B, nil, "none", nil)
