...
local function apply_base16_theme(theme)
    ...
    highlight("Bold", nil, nil, { bold = true }, nil)
    ...
    highlight("gitcommitBranch", theme.base09, nil, { bold = true }, nil)
    highlight("gitcommitUntrackedFile", theme.base0A, nil, nil, nil)
    highlight("gitcommitUnmergedFile", theme.base08, nil, { bold = true }, nil)
    highlight("gitcommitDiscardedFile", theme.base08, nil, { bold = true }, nil)
    highlight("gitcommitSelectedFile", theme.base0B, nil, { bold = true }, nil)
    ...
    highlight("TSKeywordFunction", theme.base0E, nil, { bold = true }, nil)
    highlight("TSKeywordReturn", theme.base0E, nil, "none", nil)
    highlight("TSFunction", theme.base0D, nil, { italic = true, bold = true }, nil)
    ...
    highlight("TSStrong", nil, nil, { bold = true }, nil)
