...
local function apply_base16_theme(theme)
    ...
    highlight("@text.underline", theme.base08, nil, nil, nil)
    ...
    highlight("@constant.macro", theme.base0E, nil, "none", nil)
    highlight("@define", theme.base0E, nil, "none", nil)
    highlight("@punctuation", theme.base0F, nil, nil, nil)
    ...
    highlight("@constant.builtin", theme.base0C, nil, nil, nil)
    highlight("@string.escape", theme.base0F, nil, nil, nil) -- special char
    highlight("@character.special", theme.base0F, nil, nil, nil) -- special char
    ...
    highlight("TSComment", theme.base03, nil, "italic", nil)
    ...
    highlight("TSKeywordFunction", theme.base0E, nil, "italic", nil)
    highlight("TSKeywordReturn", theme.base0E, nil, "none", nil)
    highlight("TSFunction", theme.base0D, nil, "NONE", nil)
    ...
    highlight("TSPunctSpecial", theme.base08, nil, "none", nil)
    highlight("TSStringRegex", theme.base0C, nil, "none", nil)
    highlight("TSString", theme.base0B, nil, nil, nil)
    highlight("TSConstructor", theme.base0C, nil, "none", nil)
    ...
    highlight("TSVariable", theme.base05, nil, "none", nil)
