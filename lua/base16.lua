...
local function apply_base16_theme(theme)
    ...
    highlight("lCursor", theme.base00, theme.base05, nil, nil)
    ...
    highlight("Function", theme.base0D, nil, { italic = true }, nil)
    ...
    -- treesitter
    highlight("@annotation", theme.base0F, nil, "none", nil)
    highlight("@comment", theme.base03, nil, "italic", nil)
    highlight("@attribute", theme.base0A, nil, "none", nil)
    highlight("@character", theme.base08, nil, "none", nil)
    highlight("@constant.builtin", theme.base09, nil, "none", nil)
    highlight("@Constant.macro", theme.base08, nil, "none", nil)
    highlight("@error", theme.base08, nil, "none", nil)
    highlight("@exception", theme.base08, nil, "none", nil)
    highlight("@float", theme.base09, nil, "none", nil)
    highlight("@function.builtin", theme.base0D, nil, "none", nil)
    highlight("@function.macro", theme.base08, nil, "none", nil)
    highlight("@conditional", theme.base0E, nil, nil, nil)
    highlight("@keyword", theme.base0E, nil, "none", nil)
    highlight("@keyword.function", theme.base0E, nil, "italic", nil)
    highlight("@keyword.return", theme.base0E, nil, "none", nil)
    highlight("@function", theme.base0D, nil, "NONE", nil)
    highlight("@include", theme.base0D, nil, nil, nil)
    highlight("@property", theme.base08, nil, "none", nil)
    highlight("@field", theme.base08, nil, "none", nil)
    highlight("@keyword.operator", theme.base0E, nil, "none", nil)
    highlight("@method", theme.base0D, nil, "none", nil)
    highlight("@namespace", theme.base08, nil, "none", nil)
    highlight("@none", theme.base05, nil, "none", nil)
    highlight("@parameter", theme.base08, nil, "none", nil)
    highlight("@reference", theme.base05, nil, "none", nil)
    highlight("@punctuation.delimiter", theme.base0F, nil, "none", nil)
    highlight("@punctuation.special", theme.base08, nil, "none", nil)
    highlight("@punctuation.bracket", theme.base0F, nil, "none", nil)
    highlight("@string.regex", theme.base0C, nil, "none", nil)
    highlight("TSString", theme.base0B, nil, nil, nil)
    highlight("@constructor", theme.base0C, nil, "none", nil)
    highlight("@string.escape", theme.base0C, nil, "none", nil)
    highlight("@symbol", theme.base0B, nil, "none", nil)
    highlight("@tag.delimeter", theme.base0F, nil, "none", nil)
    highlight("@text", theme.base05, nil, "none", nil)
    highlight("@text.strong", nil, nil, "bold", nil)
    highlight("@text.emphasis", theme.base09, nil, "none", nil)
    highlight("@text.strong", nil, nil, "bold", nil)
    highlight("@text.strike", theme.base00, nil, "strikethrough", nil)
    highlight("@text.literal", theme.base09, nil, "none", nil)
    highlight("@text.url", theme.base09, nil, "underline", nil)
    highlight("@type.builtin", theme.base0A, nil, "none", nil)
    highlight("@variable", theme.base05, nil, "italic", nil)
    highlight("@variable.builtin", theme.base09, nil, "none", nil)
